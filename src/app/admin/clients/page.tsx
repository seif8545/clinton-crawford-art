...
export default function ClientsPage() {
    ...
    async function load() {
        try {
            ...
            // Explicitly cast the JSON response to bypass the 'unknown' type error
                            ...
                            <div key={client.id} className="border border-whisper hover:border-gold/20 transition-colors">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-6 shrink-0 text-sm font-body">
                                        ...
                                        <div className="text-center">
                                            <p className="font-display text-xl text-gold">${(Number(client.total_spent ?? 0)).toLocaleString()}</p>
