                        ...
                        <div className="flex items-center gap-2">
                            {[
                                ...
                                <a key={f.value}
                                    ...
                                    className={`text-xs px-4 py-2 tracking-[0.15em] uppercase font-body border transition-all duration-200 ${activeStatus === f.value || (f.value === 'all' && !status)
                        ...
                        {seriesList.length > 0 && (
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <a href={`/gallery${buildQuery({ status })}`}
                                    className={`text-xs px-4 py-2 tracking-[0.15em] uppercase font-body border transition-all duration-200 ${!series ? 'border-gold/40 text-gold bg-gold/5' : 'border-whisper text-dusk/50 hover:text-ink'
                                        }`}>
                                    All
                                </a>
                                {seriesList.map(s => (
