...
export default function NotFound() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden bg-parchment">
        <div className="relative z-10 text-center max-w-xl">
          <p
            className="font-display leading-none text-gold/15 select-none mb-0"
          ...
          <div className="mt-[-2rem] mb-8">
            ...
            <p className="text-ink/55 font-body leading-relaxed">
